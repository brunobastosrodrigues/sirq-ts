...
export const LandingPage: React.FC<LandingPageProps> = ({ onStart, onOpenDocs }) => {
  return (
    <div className="min-h-screen bg-[#f8fafc] text-slate-900 font-sans selection:bg-indigo-100 overflow-y-auto">
      ...
      <header className="border-b border-slate-200 bg-white px-8 py-6">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex flex-col md:items-end text-sm font-medium text-slate-600">
             ...
             <span className="text-slate-400 text-xs">Embedded Systems Group (ESG)</span>
          </div>
        </div>
      </header>
      ...
      <main className="max-w-6xl mx-auto px-8 py-12">
        ...
        <div className="mb-16 border-b border-slate-200 pb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mt-10">
                <div className="md:col-span-2">
                    <h3 className="font-bold text-slate-900 mb-3 text-sm uppercase tracking-wide">Abstract</h3>
                    ...
                    <div className="flex gap-4 mt-8">
                        ...
                        <button onClick={onOpenDocs} className="bg-white border border-slate-300 text-slate-700 px-6 py-3 rounded text-sm font-medium hover:bg-slate-50 transition-colors flex items-center gap-2">
                            View Model Specifications <FileText size={16} />
                        </button>
                    </div>
                </div>
                
                <div className="bg-slate-100 p-6 rounded border border-slate-200 h-fit">
                    <h3 className="font-bold text-slate-900 mb-4 text-sm uppercase tracking-wide">Key Variables</h3>
                    <ul className="space-y-3 text-sm text-slate-700">
                        <li className="flex items-start gap-2">
                            <Scale size={16} className="mt-0.5 text-indigo-600" />
                            <span><strong>Mechanism:</strong> Highest-Bidder-First vs. FIFO</span>
                        </li>
                        <li className="flex items-start gap-2">
                            <Sigma size={16} className="mt-0.5 text-indigo-600" />
                            <span><strong>Pricing:</strong> Dynamic Surge ($/kWh) based on Utilization $\rho$</span>
                        </li>
                        <li className="flex items-start gap-2">
                            <GitBranch size={16} className="mt-0.5 text-indigo-600" />
                            <span><strong>Agents:</strong> Heterogeneous VOT (Critical, Standard, Economy)</span>
                        </li>
                         <li className="flex items-start gap-2">
                            <Database size={16} className="mt-0.5 text-indigo-600" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
             <div className="p-6 border-t-2 border-slate-900">
                 <h4 className="font-bold text-slate-900 mb-2">1. Rational Agents</h4>
             ...
             <div className="p-6 border-t-2 border-slate-300">
                 <h4 className="font-bold text-slate-900 mb-2">2. The "Squatter" Solution</h4>
                 <p className="text-sm text-slate-600 leading-relaxed">
             ...
             <div className="p-6 border-t-2 border-slate-300">
                 <h4 className="font-bold text-slate-900 mb-2">3. Non-Linear Physics</h4>
                 <p className="text-sm text-slate-600 leading-relaxed">
             ...
             <div className="p-6 border-t-2 border-slate-300">
                 <h4 className="font-bold text-slate-900 mb-2">4. Reproducibility</h4>
                 <p className="text-sm text-slate-600 leading-relaxed">
        ...
        {/* Footer */}
        <div className="mt-24 pt-8 border-t border-slate-200 flex justify-between text-xs text-slate-500">
